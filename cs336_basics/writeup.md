...
```text
mac $makima: ~/Desktop/code/python projects/stf_course/assignment1-basics on main ≡  ?1 ~2 ❯ uv run pytest -k test_embedding                        68.54% 10/16GB
...
```text
mac $makima: ~/Desktop/code/python projects/stf_course/assignment1-basics on main ≡ ❯ uv run pytest -k test_rmsnorm                                  72.11% 11/16GB
=============================== test session starts ===============================
platform darwin -- Python 3.13.13, pytest-9.0.2, pluggy-1.6.0
rootdir: /Users/makima/Desktop/code/python projects/stf_course/assignment1-basics
configfile: pyproject.toml
...
```text
mac $makima: ~/Desktop/code/python projects/stf_course/assignment1-basics on main ≡  ?1 ~2 ❯ uv run pytest -k test_swiglu                           70.99% 11/16GB
